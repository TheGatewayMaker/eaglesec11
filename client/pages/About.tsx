...
export default function About() {
  return (
    <div className="bg-background transition-colors duration-300">
      ...
      <section className="py-20 md:py-28 bg-background transition-colors duration-300">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16 animate-fade-in">
            ...
            <div className="overflow-hidden rounded-2xl shadow-2xl h-80 md:h-96">
              <img
      ...
      <section className="py-20 md:py-28 bg-gradient-to-r from-accent/10 to-accent/5 transition-colors duration-300 border-y border-border">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-5">
              <div className="flex gap-5 p-6 rounded-xl bg-card border-2 border-accent/30 hover:border-accent hover:shadow-lg transition-all">
